...
which choke the grounds (Figure 1). Innumerable other, smaller, fires,
scattered across the QECH campus (Figure 2) contribute their part, as
...
presented in Appendix A Figure A.1 (TODO). However, the number of measured values
...
each location, for both PM10 and PM2.5 in Figure 3. As well as dampening
...
is shown in Figure 5. Each square represents 1% of the measured time.
...
# Figure XA1. PM2.5 and PM10 values collected every 5 minutes over 10 months at 8 locations. 
# TODO: ##Lars can you please fix the x-axis labels so they aren’t squished
