...
caregivers in January and February 2021, spread around the hospital’s various wards and departments. Interviews were
...
risk. The first round of interviews included specific questions on air quality, while the second round focused on waste management more broadly. However, the semi-structured nature of the interviews allowed for
...
ggsave(filename = "manuscript/figs/fig-03-double-column.tiff",
       plot = fig03,
       dpi = param_dpi,
...
ggplot(df, aes(x = x, y = y)) +
  geom_point() +
  xlab(expression(c('PM'[10], 'PM'[2.5])))
...
ggsave(filename = "manuscript/figs/fig-04-double-column.tiff",
       plot = fig04,
       dpi = param_dpi,
       width = param_width_double,
       height = param_width_double * width_height_ratio,
...
fig05 <- ggplot(data = percent_exposure,
