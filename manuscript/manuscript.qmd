...
percent_exposure |> 
  write_csv("data/processed-data/fig05-percent-exposure.csv")
...
staff[^11] described, "we are just hoping we will start breathing good
...
```{r}
#| label: figA1-five-minute-intervals
