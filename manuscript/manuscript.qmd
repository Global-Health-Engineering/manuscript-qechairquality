...
hospital campus [@kalina2020this]. However, the vast majority of the
...
-   **The Blantyre Malaria Project (BMP)**, established by Professors
    ...
    specifically cerebral malaria, for more than 30 years. Its research
    infrastructure includes an administrative team, an inpatient
    research ward, an MRI centre, and an outpatient research clinic in
    Ndirande township and in other districts outside of Blantyre.
...
-   When a patient arrives at QECH, she or he will usually arrive with a
    ...
    and toilet/shower block are maintained by a local NGO. Though
    simple, the facility is secure and offers one of the only
